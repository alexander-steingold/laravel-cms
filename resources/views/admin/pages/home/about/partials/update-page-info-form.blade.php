<section>
    ...
    <form method="post" action="{{ route('home_about.update') }}" enctype="multipart/form-data">
        @csrf
        @method('patch')
        <div>
        ...
        <div class="mt-3">
            ...
            <x-admin.text-input id="subtitle" name="subtitle" type="text" class="mt-1 d-block"
                                :value="old('subtitle', $data->subtitle)"
                                autofocus autocomplete="subtitle"/>
            ...
            <div class="mt-3">
                <x-admin.input-label for="summary" :value="__('Summary')"/>
                <x-admin.text-input id="summary" name="subtitle" type="text" class="mt-1 d-block"
                                    :value="old('summary', $data->summary)"
                                    autofocus autocomplete="summary"/>
                <x-admin.input-error class="mt-2" :messages="$errors->get('summary')"/>
            </div>
            <div class="mt-3">
